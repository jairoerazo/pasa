...
if __name__ == "__main__":
    ...
    prompt = "You are an expert online shopper helping a user who is searching for products that match the following request: Show me products where using a smaller package size provides better value than buying larger packages. Evaluate whether the following product fully satisfies the detailed requirements of the user query and provide your reasoning. Ensure that your decision and reasoning are consistent. Searched Product: Title: {title} Description: {abstract} User Query: Show me products where using a smaller package size provides better value than buying larger packages. Output format: Decision: Yes/No Reason:... Decision:"
    print(selector.infer_score([prompt, prompt, prompt]))